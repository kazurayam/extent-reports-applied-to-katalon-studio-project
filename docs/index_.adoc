...
This link:https://github.com/kazurayam/extent-reports-applied-to-katalon-studio-project/[repository] presents a link:https://katalon.com/katalon-studio[Katalon Studio] project which integrates the link:https://extentreports.com/[Extent Reports] to compile a test execution report in HTML. The Extent Reports enables users to customize the content of the report.
...
I added a new abstrace class link:https://github.com/kazurayam/extent-reports-applied-to-katalon-studio-project/blob/develop/Keywords/com/kazurayam/ks/extentreports/ReportBuilder.groovy[`com.kazurayam.ks.extentreports.ReportBuilder`]. This abstract class borrows the method signatures of the link:https://github.com/kazurayam/extent-reports-applied-to-katalon-studio-project/blob/master/Keywords/com/katalon/extent/report/ExtentReport.groovy[`com.katalon.extent.report.ExtentReport`] class as component.

[source, groovy]
----
include::../Keywords/com/kazurayam/ks/extentreports/ReportBuilder.groovy[lines=22..28]
----
...
[source,groovy]
----
include::../Keywords/com/kazurayam/ks/extentreports/ReportBuilderOnKatalonImpl.groovy[lines=40..47]
----
...
:urlPrefix: https://github.com/kazurayam/extent-reports-applied-to-katalon-studio-project/blob/develop/docs/katalon-studio-source/10.0.0/source

link:{urlPrefix}/com.kms.katalon.core/com/kms/katalon/core/keyword/builtin/CommentKeyword.groovy[com.kms.katalon.core.keyword.builtin.CommentKeyword] extends link:{urlPrefix}/com.kms.katalon.core.webui/com/kms/katalon/core/keyword/internal/AbstractKeyword.groovy[com.kms.katalon.core.keyword.internal.AbstractKeyword].

link:{urlPrefix}/com.kms.katalon.core.webui/com/kms/katalon/core/webui/keyword/builtin/ClickKeyword.groovy[com.kms.katalon.core.webui.keyword.builtin.ClickKeyword] extends link:{urlPrefix}/com.kms.katalon.core.webui/com/kms/katalon/core/webui/keyword/internal/WebUIAbstractKeyword.groovy[com.kms.katalon.core.webui.keyword.internal.WebUIAbstractKeyword].


link:{urlPrefix}/com.kms.katalon.core.webui/com/kms/katalon/core/webui/keyword/builtin/OpenBrowserKeyword.groovy[com.kms.katalon.core.webui.keyword.builtin.OpenBrowserKeyword] extends link:{urlPrefix}/com.kms.katalon.core.webui/com/kms/katalon/core/webui/keyword/internal/WebUIAbstractKeyword.groovy[com.kms.katalon.core.webui.keyword.internal.WebUIAbstractKeyword].

link:{urlPrefix}/com.kms.katalon.core.webui/com/kms/katalon/core/webui/keyword/builtin/SetTextKeyword.groovy[com.kms.katalon.core.webui.keyword.builtin.SetTextKeyword] extends link:{urlPrefix}/com.kms.katalon.core.webui/com/kms/katalon/core/webui/keyword/internal/WebUIAbstractKeyword.groovy[com.kms.katalon.core.webui.keyword.internal.WebUIAbstractKeyword].

link:{urlPrefix}/com.kms.katalon.core.webui/com/kms/katalon/core/webui/keyword/internal/WebUIAbstractKeyword.groovy[com.kms.katalon.core.webui.keyword.internal.WebUIAbstractKeyword] extends link:{urlPrefix}/com.kms.katalon.core/com/kms/katalon/core/keyword/internal/AbstractKeyword.groovy[com.kms.katalon.core.keyword.internal.AbstractKeyword]

link:{urlPrefix}/com.kms.katalon.core/com/kms/katalon/core/keyword/internal/AbstractKeyword.groovy[com.kms.katalon.core.keyword.internal.AbstractKeyword] uses link:{urlPrefix}/com.kms.katalon.core/com/kms/katalon/core/logging/KeywordLogger.java[com.kms.katalon.core.logging.KeywordLogger]

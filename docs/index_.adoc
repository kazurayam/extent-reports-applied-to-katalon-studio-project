...
Katalon offers a plugin named link:https://docs.katalon.com/katalon-studio/integrations/test-analysis/extent-reports-integration[ExtentReport integration plugin]. It was first published in April 2024 on GitHub as a free stuff.
...
We can read the link:https://store.katalon.com/product/387/Extent-Report-Integration/change-logs[Changelog] of the integration plugin. The Changelong shows that several updates was made at 05 Feb 2025. I believe, the plugin will be maintained by Katalon as needed in future.

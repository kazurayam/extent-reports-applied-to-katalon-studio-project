...
CustomKeywords.'com.katalon.extent.report.ExtentReport.attachLog'('Open Browser')
...
CustomKeywords.'com.katalon.extent.report.ExtentReport.attachLog'('Input Username as John Doe')
...
CustomKeywords.'com.katalon.extent.report.ExtentReport.attachLog'('Input Encrypted Password ')

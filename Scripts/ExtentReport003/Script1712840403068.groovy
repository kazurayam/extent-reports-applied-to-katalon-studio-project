...
CustomKeywords.'com.katalon.extent.report.ExtentReport.attachLog'('Start Browser')

WebUI.navigateToUrl('https://katalon-demo-cura.herokuapp.com/')

CustomKeywords.'com.katalon.extent.report.ExtentReport.attachLog'('Navigate to Url https://katalon-demo-cura.herokuapp.com/2')

String title = WebUI.getWindowTitle()

CustomKeywords.'com.katalon.extent.report.ExtentReport.attachLog'('Title- ' + title)

WebUI.click(findTestObject('Object Repository/OR Web/Page_CURA Healthcare Service/a_Make Appointment'))

CustomKeywords.'com.katalon.extent.report.ExtentReport.attachLog'('Click Make Appointment')

WebUI.setText(findTestObject('Object Repository/OR Web/Page_CURA Healthcare Service/input_Username_username'), 'John Doe')

CustomKeywords.'com.katalon.extent.report.ExtentReport.attachLog'('Enter Username as John Doe')
...
CustomKeywords.'com.katalon.extent.report.ExtentReport.attachLog'('Enter Encrypted password')

WebUI.click(findTestObject('Object Repository/OR Web/Page_CURA Healthcare Service/button_Login'))

CustomKeywords.'com.katalon.extent.report.ExtentReport.attachLog'('Click button_Login')
...
CustomKeywords.'com.katalon.extent.report.ExtentReport.attachLog'('button_Book Appointment')

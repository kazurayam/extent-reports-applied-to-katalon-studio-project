...
public class ExtentReport {
	...
	@Keyword
	def attachReport(TestSuiteContext testSuiteContext, String setDocumentTitle, String setReportTitle) {
		println testSuiteContext.getTestSuiteId()

		sparkReporter = new ExtentSparkReporter(RunConfiguration.getProjectDir()+"/Extent/"+setReportTitle.replaceAll(" ", "").toLowerCase()+".html");
	...
	@Keyword
	def startReport(TestCaseContext testCaseContext) {
	...
	public void addScreenshot(String) {
		...
		extentTest.log(Status.PASS, 'Screenshot added.', MediaEntityBuilder.createScreenCaptureFromPath(screenshotpathLaunched).build())
	}
